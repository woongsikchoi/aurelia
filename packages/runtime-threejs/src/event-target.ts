...
export class EventTarget {
  ...
  public addEventListener(type: string, handler: EventListenerOrEventListenerObject, options: boolean | IEventListenerOptions): void {
  ...
  public removeEventListener(type: string, handler: EventListenerOrEventListenerObject, options: boolean | IEventListenerOptions): void {

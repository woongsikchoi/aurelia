...
export class RenderPlan {
  ...
  constructor(node: unknown, instructions: TargetedInstruction[][], dependencies: ReadonlyArray<IRegistry>) {
  ...
  /** @internal */
  public mergeInto(dom: IDOM, parent: unknown, instructions: TargetedInstruction[][], dependencies: IRegistry[]): void {
...
function addChildren(dom: IDOM, parent: unknown, children: ArrayLike<unknown>, allInstructions: TargetedInstruction[][], dependencies: IRegistry[]): void {
    ...
    switch (typeof current) {
      ...
      case 'object':
        if (dom.isNodeInstance(current)) {
          ...
          (current as RenderPlan).mergeInto(dom, parent, allInstructions, dependencies);
        }
    }
  }
}
